...
static LState::StateMachine<sm_state_t, sm_event_t>::sm_transition_t
    my_transition_table[] = {
        ...
        {SM_STATE_IDLE, SM_EVENT_RUN, SM_STATE_RUN},
        {SM_STATE_RUN, SM_EVENT_IDLE, SM_STATE_IDLE},
        {SM_STATE_INIT, SM_EVENT_ERROR_INIT, SM_STATE_ERROR},
        {SM_STATE_IDLE, SM_EVENT_ERROR_IDLE, SM_STATE_ERROR},
        {SM_STATE_RUN, SM_EVENT_ERROR_RUN, SM_STATE_ERROR},
};
